...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-19 14:56`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/f347fa32-8c4e-4b4e-adfe-7c1a311caff2.git
$ cd f347fa32-8c4e-4b4e-adfe-7c1a311caff2
```
